...
<div class="content-right">
	<div class="content-r-pic_w">
		<div style="margin:8px auto auto 12px;margin-top:6px">
			<span class="page_title">订单报表</span>
		</div>
	</div>
			...
			<div class="square-o-top">
				<table width="100%" border="0" cellpadding="0" cellspacing="0"
					...
					<tr>
						...
						<td width="140">
							<input type="radio" name="all" checked="checked">货物名称
						</td>
						<td width="70">订单类别:</td>
						<td width="190">
							<s:select name="bqm.type" list="@model.OrderModel@buyTypeMap" headerKey="-1" headerValue="---请-选-择---"></s:select>
						</td>
						<td width="70">开始日期:</td>
						<td width="190">
			...
			<div class="square-order">
				<table width="70%" border="1" cellpadding="0" cellspacing="0" style="float:left;">
					<tr align="center"
						...
						<td colspan="2" width="49%" height="30">货物名称</td>
