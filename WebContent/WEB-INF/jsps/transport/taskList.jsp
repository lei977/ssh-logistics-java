...
<div class="content-right">
	<div class="content-r-pic_w">
		<div style="margin:8px auto auto 12px;margin-top:6px">
			<span class="page_title">物品运输管理</span>
		</div>
	</div>
			...
			<div class="square-o-top">
				<table width="100%" border="0" cellpadding="0" cellspacing="0"
					...
					<tr>
						...
						<td>发货方式:</td>
						<td>
							<s:select name="oqm.sm.needs" list="@model.SupplierModel@needsMap" headerKey="-1" headerValue="---请-选-择---" cssStyle="width:115px"></s:select>
						</td>
						<td>审核人:</td>
				...
				<table width="100%" border="1" cellpadding="0" cellspacing="0">
					...
					<s:iterator value="orderList">	
						<tr align="center" bgcolor="#FFFFFF">
							...
							<td>${sm.needsView }</td>
							<td>
							<s:if test=" type == @model.OrderModel@ORDER_TYPE_OF_BUY_CHECK_PASS">
